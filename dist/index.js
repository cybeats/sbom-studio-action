...
if (!globalThis.ReadableStream) {
  ...
  try {
    ...
    Object.assign(globalThis, __nccwpck_require__(866))
  }
}
...
/* harmony import */ var _service_signed_url_service_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(521);
/* harmony import */ var _service_json_generator_js__WEBPACK_IMPORTED_MODULE_6__ = __nccwpck_require__(790);
/* harmony import */ var _service_import_service_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(756);
/* harmony import */ var _service_file_upload_service_js__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(23);
/* harmony import */ var _service_dependency_vulnerabilities_service_js__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(897);
/* harmony import */ var _service_sha_service_js__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(550);
...
try {
    if (!(0,_service_sha_service_js__WEBPACK_IMPORTED_MODULE_4__/* .checkFile */ .Oo)(filePath))
        process.exit(1)
} catch (err) {
    console.log("Incorrect filePath. Please check if file is missing.")
    process.exit(1)
}
let fileName = path__WEBPACK_IMPORTED_MODULE_5__.basename(filePath);

const extension = path__WEBPACK_IMPORTED_MODULE_5__.extname(fileName);
if (extension == "")
    contentType = "application/octet-stream";
else contentType = "application/" + extension.replace(".", "");

fileName = path__WEBPACK_IMPORTED_MODULE_5__.basename(filePath);
const fileCheckSum = (0,_service_sha_service_js__WEBPACK_IMPORTED_MODULE_4__/* .fileCheckSumCalculate */ .mR)(filePath);
const jsonBody = (0,_service_json_generator_js__WEBPACK_IMPORTED_MODULE_6__/* .generateJson */ .U)(
    fileCheckSum,
    fileName,
    contentType,
    manufactureName,
...
// (async () => {
const importResult = await (0,_service_import_service_js__WEBPACK_IMPORTED_MODULE_1__/* .addImport */ .r)(
    jsonBody,
    secretAccessKey,
    accessKey,
    url
...
//     accessKey
// );
if (!(0,_service_file_upload_service_js__WEBPACK_IMPORTED_MODULE_2__/* .uploadFile */ .c)(filePath, signedUrl, fileCheckSum)) {
...
let importedAt = true;
while (runLoop) {
    let result = await (0,_service_import_service_js__WEBPACK_IMPORTED_MODULE_1__/* .getImportByKey */ .B)(
        importId,
        secretAccessKey,
        accessKey,
        url
...
if (threshold != undefined && threshold != '') {
    let result = await (0,_service_dependency_vulnerabilities_service_js__WEBPACK_IMPORTED_MODULE_3__/* .getDependencyVulnearabilities */ .A)(
        importId,
        secretAccessKey,
        accessKey,
        url
    ...
    while (result == undefined) {
        result = await (0,_service_dependency_vulnerabilities_service_js__WEBPACK_IMPORTED_MODULE_3__/* .getDependencyVulnearabilities */ .A)(
            importId,
            secretAccessKey,
            accessKey,
            url
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(380);
...
var node_domexception = __nccwpck_require__(213);
// EXTERNAL MODULE: ./node_modules/fetch-blob/file.js
var file = __nccwpck_require__(225);
// EXTERNAL MODULE: ./node_modules/fetch-blob/index.js
var fetch_blob = __nccwpck_require__(380);
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(804);
...
/* harmony export */ });
/* unused harmony export File */
/* harmony import */ var fetch_blob__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(380);
/* harmony import */ var fetch_blob_file_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(225);
...
var esm_min = __nccwpck_require__(264);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require__.e(/* import() */ 645).then(__nccwpck_require__.bind(__nccwpck_require__, 645));
...
var from = __nccwpck_require__(629);
...
/* harmony export */ });
/* harmony import */ var _request_service_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(362);
...
async function getDependencyVulnearabilities(
    ...
    return await (0,_request_service_js__WEBPACK_IMPORTED_MODULE_0__/* .doRequest */ .N)(body, secretAccessKey, accessKey, url + "/v1/sboms/componentcatalog/software");
};
...
/* harmony export */ });
/* harmony import */ var _sha_service_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(550);
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(17);
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(215);




async function uploadFile(filePath, url, fileCheckSum) {
    const fileName = (0,path__WEBPACK_IMPORTED_MODULE_1__.basename)(filePath);
    const extension = (0,path__WEBPACK_IMPORTED_MODULE_1__.extname)(fileName);
    let contentType;
    ...
    (0,node_fetch__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .ZP)(url,
        {
            method: "PUT",
            headers: {
...
async function addImport(
    ...
    return await (0,_request_service_js__WEBPACK_IMPORTED_MODULE_0__/* .doRequest */ .N)(body, secretAccessKey, accessKey, url + "/v1/sboms/imports/add");
};
...
async function getImportByKey(
    ...
    return await (0,_request_service_js__WEBPACK_IMPORTED_MODULE_0__/* .doRequest */ .N)(body, secretAccessKey, accessKey, url + "/v1/sboms/imports/getbykey");
};
...
/* harmony export */ });
/* harmony import */ var _sha_service_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(550);
/* harmony import */ var node_fetch__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(215);
...
async function doRequest(
    ...
    const req = await (0,node_fetch__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)(url, {
        method: "POST",
        headers: {
...
;// CONCATENATED MODULE: ./service/sha.service.js



function calculate(timestamp, body, secretAccessKey) {
    const hmacAlg = "SHA256";
    const data = timestamp + JSON.stringify(body);
    // Build session signature
    let sessionSignature = (0,external_crypto_namespaceObject.createHmac)(hmacAlg, secretAccessKey)
        .update(data)
        .digest("base64");
...
function fileCheckSumCalculate(filePath) {
    const fileBuffer = (0,external_fs_namespaceObject.readFileSync)(filePath);
...
async function readFileContent(file) {
    const contents = (0,external_fs_namespaceObject.readFileSync)(file, "utf-8");
    return contents;
};

function checkFile(fileUrl) {
    if (!(0,external_fs_namespaceObject.existsSync)(fileUrl)) {
...
/* unused harmony export signedUrlService */
/* harmony import */ var _sha_service_js__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(550);
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(17);
